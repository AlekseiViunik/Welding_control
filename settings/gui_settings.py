...
# Имя Главного окна
# Default: "iWant - v1.0.0"
MAIN_WINDOW_TITLE = "iWant - v1.0.0"

# Имя окна настроек
# Default: "Настройки"
SETTINGS_WINDOW_TITLE = "Настройки"

WELD_CONTROL_WINDOW_TITLE = "Weld control"

# Размеры стартового окна
WINDOW_WIDTH = 600  # Default: 600
WINDOW_HEIGHT = 400  # Default: 400

# ===================Настройки для стартового окна===================

# Варианты выбора операции для выпадающего списка стартовой страницы.
# Default:
# CHOSE_START_OPTIONS = [
#     'Проверить даты контроля сварных соединений': '01',
#     'Составить протокол неразрушающего контроля': '02',
#     'Составить производственную спецификацию': '03',
#     'Написать служебную записку': '04',
# ]
CHOSE_START_OPTIONS = {
    'Проверить даты контроля сварных соединений': '01',
    'Составить протокол неразрушающего контроля': '02',
...
# Подсказка для выпадающего списка стартовой страницы
# Default: 'Выбери, что ты хочешь замутить!'
CHOSE_HINT = 'Выбери, что ты хочешь замутить!'
